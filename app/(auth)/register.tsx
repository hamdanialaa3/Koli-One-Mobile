...
const styles = StyleSheet.create({
  ...
  registerButton: {
    ...
    gap: 10,
    ...Platform.select({
      ios: { shadowColor: theme.colors.primary.main, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 12 },
      android: { elevation: 6 },
      default: { boxShadow: '0px 4px 12px rgba(230, 80, 0, 0.3)' },
    }),
    marginBottom: 20,
  },
